...
public interface TreeTableSorter<T extends TreeModel, C extends TreeColumnModel> {
	...
	/**
	 * Retrieves the RowSorter for the specified path, creates it if necessary.
	 * 
	...
	/**
	 * Differs from the TreePath variety as it won't (lacks the necessary
	 * information) create the row sorter if it doesn't exist.
	 * 
