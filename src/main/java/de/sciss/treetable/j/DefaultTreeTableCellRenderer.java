...
public class DefaultTreeTableCellRenderer extends JLabel implements TreeTableCellRenderer, TableCellRenderer {
	...
	public Component getTreeTableCellRendererComponent(TreeTable treeTable, Object value, boolean selected,
		...
		treeTable.getUI().configureCellRenderer(this, treeTable, value, selected, hasFocus, row, column);
		setValue(value);
		return this;
	}
	...
	public Component getTreeTableCellRendererComponent(TreeTable treeTable, Object value, boolean selected,
		...
		treeTable.getUI().configureCellRenderer(this, treeTable, value, selected, hasFocus, row, column, expanded,
				leaf);
		setValue(value);
		return this;
	}
	...
	/**
	 * This class implements the TableCellRenderer interface as a convenience so
	 * that it can be stored as a renderer in a TableColumn.
	 * <p>
