...
/**
 * The QuaquaMavericksFileChooserLAF is an extension for Apple's Aqua Look and
 * Feel for Mac OS X 10.9 (Mavericks).
 * <p>
...
public class QuaquaMavericksFileChooserLAF extends Quaqua16LionFileChooserLAF {
	...
	protected void initClassDefaults(UIDefaults table) {
		...
		Object[] uiDefaults = { "BrowserUI", quaquaPrefix + "BrowserUI", "FileChooserUI",
				quaquaMavericksPrefix + "FileChooserUI", };
	...
	protected void initComponentDefaults(UIDefaults table) {
		...
		Object[] uiDefaults = { "FileChooser.listView.extraColumnTextColor", new ColorUIResource(80, 80, 80),
