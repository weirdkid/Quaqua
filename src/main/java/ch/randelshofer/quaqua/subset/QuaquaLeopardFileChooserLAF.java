...
/**
 * The QuaquaLeopardFileChooserLAF is an extension for Apple's Aqua Look and
 * Feel for Java 1.5 on Mac OS X 10.5 (Leopard).
 * <p>
...
public class QuaquaLeopardFileChooserLAF extends LookAndFeelProxy {
	...
	/**
	 * The small system font (Lucida Grande Regular 11 pt) is used for informative
	 * text in alerts. It is also the default font for column headings in lists, for
	 * help tags, and for small controls. You can also use it to provide additional
	 * information about settings in various windows, such as the QuickTime pane in
	 * System Preferences.
	 */
	protected static final FontUIResource SMALL_SYSTEM_FONT = new FontUIResource("Lucida Grande", Font.PLAIN, 11);
	...
	protected void initClassDefaults(UIDefaults table) {
		...
		Object[] uiDefaults = { "BrowserUI", quaquaPrefix + "BrowserUI", "FileChooserUI",
				quaquaLeopardPrefix + "FileChooserUI", };
	...
	protected void initFontDefaults(UIDefaults table) {
		...
		Object[] uiDefaults = { "SystemFont", systemFont, "EmphasizedSystemFont", emphasizedSystemFont,
				...
				"FileChooser.previewLabelFont", emphasizedSmallSystemFont, "FileChooser.previewValueFont",
				smallSystemFont, };
	...
	protected void initComponentDefaults(UIDefaults table) {
		...
		// this used to end with Toolbar. Apple must have moved this in a later macOS
		// version
		...
		Object[] uiDefaults = { "Browser.expandedIcon",
				...
				isQuickLookEnabled, "FileChooser.orderByType", isOrderByType, "FileChooser.previewLabelForeground",
				new ColorUIResource(0x808080), "FileChooser.previewValueForeground", new ColorUIResource(0x000000),
				...
				"FileChooser.sideBarIcon.Applications",
				makeNativeIcon(sideBarIconsStart + "Apps" + sideBarIconsEnd, 16), "FileChooser.sideBarIcon.Desktop",
				makeNativeIcon(sideBarIconsStart + "Desktop" + sideBarIconsEnd, 16),
				"FileChooser.sideBarIcon.Documents",
				makeNativeIcon(sideBarIconsStart + "Documents" + sideBarIconsEnd, 16),
				"FileChooser.sideBarIcon.Downloads",
				makeNativeIcon(sideBarIconsStart + "Downloads" + sideBarIconsEnd, 16), "FileChooser.sideBarIcon.Home",
				makeNativeIcon(sideBarIconsStart + "Home" + sideBarIconsEnd, 16), "FileChooser.sideBarIcon.Library",
				makeNativeIcon(sideBarIconsStart + "Library" + sideBarIconsEnd, 16), "FileChooser.sideBarIcon.Movies",
				makeNativeIcon(sideBarIconsStart + "Movie" + sideBarIconsEnd, 16), // Note: no "s" in "Movie"
				"FileChooser.sideBarIcon.Music", makeNativeIcon(sideBarIconsStart + "Music" + sideBarIconsEnd, 16),
				"FileChooser.sideBarIcon.Pictures",
				makeNativeIcon(sideBarIconsStart + "Pictures" + sideBarIconsEnd, 16), "FileChooser.sideBarIcon.Public",
				makeNativeIcon(sideBarIconsStart + "Public" + sideBarIconsEnd, 16), "FileChooser.sideBarIcon.Sites",
				makeNativeIcon(sideBarIconsStart + "Sites" + sideBarIconsEnd, 16), "FileChooser.sideBarIcon.Utilities",
				makeNativeIcon(sideBarIconsStart + "Utilities" + sideBarIconsEnd, 16),
				//
				...
				//
				"Tree.collapsedIcon", makeIcon(getClass(), leopardDir + "Tree.collapsedIcon.png"), "Tree.expandedIcon",
				makeIcon(getClass(), leopardDir + "Tree.expandedIcon.png"), "Tree.leafIcon",
				makeIcon(getClass(), leopardDir + "Tree.leafIcon.png"), "Tree.openIcon",
				...
				new InactivatableColorUIResource(0xd5dde5, 0xe8e8e8), "Tree.sideBar.selectionBorder",
				new UIDefaults.ProxyLazyValue("ch.randelshofer.quaqua.leopard.QuaquaLeopardSideBarSelectionBorder"),
				"Tree.leftChildIndent", 8, // 7
				"Tree.rightChildIndent", 12, // 13
				"Tree.icons", makeIcons(leopardDir + "Tree.icons.png", 15, true), "Tree.sideBar.icons",
				makeIcons(leopardDir + "Tree.sideBar.icons.png", 15, true),
				...
				"Tree.sideBar.font", new FontUIResource("Lucida Grande", Font.PLAIN, 11), "Tree.sideBar.selectionFont",
				new FontUIResource("Lucida Grande", Font.BOLD, 11), "Tree.sideBarCategory.selectionForeground",
				new InactivatableColorUIResource(0xffffff, 0xffffff), "Tree.sideBarCategory.style", "emboss",
				"Tree.sideBarCategory.selectionStyle", "shadow", "Tree.sideBar.style", "plain",
				"Tree.sideBar.selectionStyle", "shadow", "Sheet.showAsSheet", Boolean.TRUE,//
		};
		table.putDefaults(uiDefaults);
	}
