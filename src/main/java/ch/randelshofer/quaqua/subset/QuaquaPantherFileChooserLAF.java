...
/**
 * The QuaquaPantherFileChooserLAF is an extension for Apple's Aqua Look and
 * Feel for Java 1.4 on Mac OS X 10.3 (Panther).
 * <p>
...
public class QuaquaPantherFileChooserLAF extends LookAndFeelProxy {
	...
	protected void initClassDefaults(UIDefaults table) {
		...
		Object[] uiDefaults = { "BrowserUI", quaquaPrefix + "BrowserUI", "FileChooserUI",
				quaquaPantherPrefix + "FileChooserUI", };
	...
	protected void initComponentDefaults(UIDefaults table) {
		...
		Object[] uiDefaults = { "Browser.expandedIcon",
				...
				new ColorUIResource(0x000000), "FileChooser.previewValueForeground", new ColorUIResource(0x000000),
				"FileChooser.previewLabelFont", smallSystemFont, "FileChooser.previewValueFont", smallSystemFont,
				"FileChooser.splitPaneDividerSize", 6, "FileChooser.previewLabelInsets",
				new InsetsUIResource(0, 0, 0, 4), "FileChooser.cellTipOrigin", new Point(18, 1),
				"FileChooser.autovalidate", Boolean.TRUE, "FileChooser.browserFocusCellHighlightBorder",
