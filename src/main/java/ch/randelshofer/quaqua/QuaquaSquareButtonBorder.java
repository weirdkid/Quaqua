...
public class QuaquaSquareButtonBorder extends CachedPainter implements Border {
	private final static Color[] defaultColors = { new Color(0x828282), // border
	...
	private final static Color[] selectedColors = { new Color(0x484848), // border
	...
	private final static Color[] disabledColors = { new Color(0x99828282, true), // border
	...
	private final static Color[] disabledSelectedColors = { new Color(0x99484848, true), // border
