...
/**
 * QuaquaTextCursorHandler hides the cursor when a key is pressed in a
 * JTextComponent and shows it again when the cursor is moved.
 *
...
public class QuaquaTextCursorHandler implements MouseMotionListener, KeyListener {
	...
	/**
	 * Holds the JTextComponent on which we hid the cursor because a key was typed.
	 */
