...
public class QuaquaLazyActionMap extends ActionMapUIResource {
	 ...
	 * @param defaultsKey Key to use to defaults table to check for existing map and
	...
	private void loadIfNecessary() {
		if (_loader != null) {
			...
			try {
				Method method = klass.getDeclaredMethod("loadActionMap", new Class[] { QuaquaLazyActionMap.class });
