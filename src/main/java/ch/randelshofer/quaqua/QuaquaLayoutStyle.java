...
public class QuaquaLayoutStyle extends LayoutStyle {
	...
	private final static Object[][] relatedGapDefinitions = {
			...
			// http://developer.apple.com/documentation/UserExperience/Conceptual/OSXHIGuidelines/XHIGControls/chapter_18_section_3.html#//apple_ref/doc/uid/20000957-TP30000359-TPXREF198
			{ "ComboBoxUI", new Insets(8, 5, 8, 5), new Insets(10, 6, 10, 6), new Insets(12, 8, 12, 8) },
			...
			// other components.
			{ "LabelUI", new Insets(6, 8, 6, 8), new Insets(6, 8, 6, 8), new Insets(6, 8, 6, 8) },
			// ? spacing not given
			...
			{ "SliderUI.horizontal", new Insets(6, 8, 6, 8), new Insets(6, 10, 6, 10), new Insets(6, 12, 6, 12) },
	...
	private final static Object[][] unrelatedGapDefinitions = {
			...
			{ "default", new Insets(12, 12, 12, 12), new Insets(14, 14, 14, 14), new Insets(16, 16, 16, 16) }, };
	/**
	...
	private final static Object[][] indentGapDefinitions = {
			// UI, mini, small, regular
			{ "default", new Insets(16, 16, 16, 16), new Insets(20, 20, 20, 20), new Insets(25, 25, 25, 25) }, };

	/**
	 * Creates a hash map for the specified definitions array.
	 *
	 * Each entry of the hash map has the name of an UI (optionally followed by a
	 * full stop and a style name) as its key <String> and an array of Insets as its
	 * value <Insets[]>.
	 */
	...
	/**
	 * The unrelatedGapDefinitions table defines the preferred gaps of one party of
	 ...
	 * component.
	 *
	 * @param component1 the <code>JComponent</code> <code>component2</code> is
	 ...
	 * @param parent     the parent of <code>component2</code>; this may differ from
	 ...
	 *                                  <code>SwingConstants.EAST</code> or
	 *                                  <code>SwingConstants.WEST</code>;
	 *                                  <code>type</code> not one of
	 *                                  <code>INDENT</code>, <code>RELATED</code> or
	 *                                  <code>UNRELATED</code>; or
	 *                                  <code>component1</code> or
	...
	private Insets getPreferredGap(JComponent component, javax.swing.LayoutStyle.ComponentPlacement type,
			int sizeStyle) {
		Insets gap = null;
		...
		if (uid.equals("ButtonUI") || uid.equals("ToggleButtonUI")) {
			...
			style = (((JSlider) component).getOrientation() == SwingConstants.HORIZONTAL) ? "horizontal" : "vertical";
	 ...
	 * @param position  the position <code>component</code> is being placed relative
	 *                  to its parent; one of <code>SwingConstants.NORTH</code>,
	 *                  <code>SwingConstants.SOUTH</code>,
	 *                  <code>SwingConstants.EAST</code> or
	 *                  <code>SwingConstants.WEST</code>
	 * @param parent    the parent of <code>component</code>; this may differ from
	 *                  the actual parent and may be null
	...
	private Insets getVisualMargin(JComponent component) {
		try {
			...
			if (ui instanceof VisuallyLayoutable) {
				...
				Rectangle visualBounds = ((VisuallyLayoutable) ui).getVisualBounds(component,
						VisuallyLayoutable.COMPONENT_BOUNDS, size.width, size.height);
				return new Insets(visualBounds.y, visualBounds.x, size.height - visualBounds.y - visualBounds.height,
						size.width - visualBounds.x - visualBounds.width);
			}
	...
	private Insets getVisualIndent(JComponent component) {
		try {
			...
			if (ui instanceof VisuallyLayoutable) {
				Dimension size = component.getPreferredSize();
				Rectangle visualBounds = ((VisuallyLayoutable) ui).getVisualBounds(component,
						VisuallyLayoutable.TEXT_BOUNDS, size.width, size.height);
				return new Insets(visualBounds.y, visualBounds.x, size.height - visualBounds.y - visualBounds.height,
						size.width - visualBounds.x - visualBounds.width);
			}
		} catch (NoSuchMethodException e) {
