 ...
 * @version $Id: MultipleGradientPaintContext.java,v 1.19 2004/08/18 07:13:41
 *          vhardy Exp $
 *
 */
abstract class MultipleGradientPaintContext implements PaintContext {
	 ...
	 * first.
	 **/
	public MultipleGradientPaintContext(ColorModel cm, Rectangle deviceBounds, Rectangle2D userBounds,
	...
	protected final void calculateGradientFractions(Color[] loColors, Color[] hiColors) {
		...
		if (colorSpace == MultipleGradientPaint.LINEAR_RGB) {
			for (int i = 0; i < loColors.length; i++) {
				loColors[i] = new Color(SRGBtoLinearRGB[loColors[i].getRed()], SRGBtoLinearRGB[loColors[i].getGreen()],
						SRGBtoLinearRGB[loColors[i].getBlue()], loColors[i].getAlpha());

				hiColors[i] = new Color(SRGBtoLinearRGB[hiColors[i].getRed()], SRGBtoLinearRGB[hiColors[i].getGreen()],
						SRGBtoLinearRGB[hiColors[i].getBlue()], hiColors[i].getAlpha());
			}
		}
	...
	private void interpolate(int rgb1, int rgb2, int[] output) {
		...
		for (int i = 0; i < output.length; i++) {
			output[i] = (((int) ((a1 + i * da * stepSize) + .5) << 24))
					| (((int) ((r1 + i * dr * stepSize) + .5) << 16)) | (((int) ((g1 + i * dg * stepSize) + .5) << 8))
