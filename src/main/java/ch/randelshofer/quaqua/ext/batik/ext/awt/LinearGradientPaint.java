...
public final class LinearGradientPaint extends MultipleGradientPaint {
	...
	public LinearGradientPaint(float x1, float y1, Color color1, float x2, float y2, Color color2) {
		this(x1, y1, x2, y2, new float[] { 0f, 1f }, new Color[] { color1, color2 });
	}

	/**
	 * <p>
	 * Constructs an {@code LinearGradientPaint} with the default NO_CYCLE repeating
	 * method and SRGB colorspace.
	 *
	...
	/**
	 * <p>
	 * Constructs an {@code LinearGradientPaint} with default SRGB colorspace.
	 *
	 * @param startX      the x coordinate of the gradient axis start point in user
	 *                    space
	 *
	...
	/**
	 * <p>
	 * Constructs a {@code LinearGradientPaint} with the default NO_CYCLE repeating
	 * method and SRGB colorspace.
	 *
	 ...
	 *
	 * @param cm           {@link ColorModel} that receives the {@code Paint} data.
	 ...
	 *         first color of this {@code LinearGradientPaint}.
	 */
	 ...
	 * 
	 * @return a {@link Point2D} object that is a copy of the point that anchors the
	 *         last color of this {@code LinearGradientPaint}.
	 */
