...
public final class RenderingHintsKeyExt {
	 ...
	 * create a Graphics2D from a BufferedImage, this will ensure that the proper
	 * things are done in the processes of creating the Graphics.
	 */
	...
	/**
	 * Hint for the ch.randelshofer.quaqua.ext.batik.ext.awt.image.GraphicsUtil
	 * class that tiling of a bitmap during rendering is undesired. This is
	 * primarily for the PDF and PostScript transcoders where tiling can lead to
