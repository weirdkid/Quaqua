...
public class LocalizableSupport implements Localizable {
	...
	/**
	 * Implements
	 * {@link ch.randelshofer.quaqua.ext.batik.i18n.Localizable#setLocale(Locale)}.
	 */
	@Override
	public void setLocale(Locale l) {
		if (locale != l) {
	...
	/**
	 * Implements
	 * {@link ch.randelshofer.quaqua.ext.batik.i18n.Localizable#getLocale()}.
	 */
	@Override
	...
	/**
	 * Implements
	 * {@link ch.randelshofer.quaqua.ext.batik.i18n.Localizable#formatMessage(String,Object[])}.
	 */
	@Override
	public String formatMessage(String key, Object[] args) {
	...
	protected boolean hasNextResourceBundle(int i) {
		if ((i == 0) || (i < resourceBundles.size())) {
			return true;
		}

		if ((lastResourceClass == null) || (lastResourceClass == Object.class)) {
			return false;
		}
		return true;
	}
