...
public class Base64 {
	...
	private final static byte[] _NATIVE_ALPHABET = /* May be something funny like EBCDIC */ { (byte) 'A', (byte) 'B',
			...
			(byte) 'v', (byte) 'w', (byte) 'x', (byte) 'y', (byte) 'z', (byte) '0', (byte) '1', (byte) '2', (byte) '3',
	 ...
	 * <code>java.io.OutputStream</code>, given in the constructor, and encode/decode
	 * to/from Base64 notation on the fly.
	 *
	 * @see Base64
	 * @since 1.3
