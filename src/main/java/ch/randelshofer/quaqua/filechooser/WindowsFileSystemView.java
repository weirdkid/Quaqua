...
public class WindowsFileSystemView extends QuaquaFileSystemView {
	...
	public File[] getRoots() {
		...
		/*
		 * File[] roots1 = getFiles(volumesFolder, true); File[] roots2 = new
		 * File[roots1.length + 1]; roots2[0] = volumesFolder; System.arraycopy(roots1,
		 * 0, roots2, 1, roots1.length); return roots2;
		 */
	}
