...
public class SavedSearchFileSystemTreeModel extends FileSystemTreeModel {
	...
	public TreePath toPath(File file, TreePath templatePath) {
		...
		/*
		 * When this method is called, templatePath should be null or the root path and
	...
	/**
	 * A node representing a saved search. A saved search is represented as a file.
	 * However, to the user it appears on the sidebar and acts like a root
	 * directory.
	 */
