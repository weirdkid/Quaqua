 ...
 * or select a directory within that subtree.
 *
...
public interface SubtreeFileChooserUI {
	...
	/**
	 * Set the current directory. If possible, the subtree root is not changed.
	 * Otherwise, the specified directory becomes the new subtree root.
	 */
