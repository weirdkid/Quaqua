...
public interface FileInfo {
	...
	/**
	 * Lazyily returns the resolved file object. Returns null, if the file object
	...
	/**
	 * Returns true, if the file object is acceptable, i.e. selectable in the
	 * JFileChooser.
	 */
	public boolean isAcceptable();

	/**
	 * Returns the (color) label of the file. Returns -1 if the label has not (yet)
	 * been determined.
	 */
	public int getFileLabel();

	/**
	 * Returns the tag names f the file. Returns null if the tag names have not
	 * (yet) been determined.
	 */
	...
	/**
	 * Returns the length of the file. Returns -1 if the length has not (yet) been
	 * determined.
	 */
	public long getFileLength();

	/**
	 * Returns the kind of the file. Returns null if the kind has not (yet) been
	 * determined.
	 */
	public String getFileKind();

	/**
	 * Returns true if a worker thread is validating the information provided by
