 ...
 * QuaquaFileSystemView acts as a wrapper on platform specific file system
 * views. The resulting view is an Aqua-style view on the file system.
 *
...
public abstract class QuaquaFileSystemView extends FileSystemViewFilter {
	...
	/**
	 * Sets the QuaquaFileSystemView. Set this to null, if you want Quaqua determine
	 * which file system view to use.
	 */
