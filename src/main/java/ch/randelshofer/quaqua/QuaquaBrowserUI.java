...
public class QuaquaBrowserUI extends BasicBrowserUI implements ViewportPainter {
	...
	private static JScrollBar getVerticalBar() {
		if (verticalBar == null) {
			verticalBar = new JScrollBar(Adjustable.VERTICAL, 0, 1, 0, 1) {
				private static final long serialVersionUID = 1L;

				/**
				 * To use this scrollBar as a renderer pane component, we have to always return
				 * true in method isShowing.
				 */
				@Override
				 ...
				 * children of the scrollbar are actually painted. This seems odd. Maybe I am
