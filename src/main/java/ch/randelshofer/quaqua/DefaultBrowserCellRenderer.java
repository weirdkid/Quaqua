...
public class DefaultBrowserCellRenderer extends JLabel implements BrowserCellRenderer {
	 ...
	 * effect of letting the background color of the JBrowser show through. On the
	 ...
	 * from messaging the browser with <code>convertValueToText</code>, which
	 ...
	 */
	@Override
	public Component getBrowserCellRendererComponent(JBrowser browser, Object value, boolean sel, boolean expanded,
