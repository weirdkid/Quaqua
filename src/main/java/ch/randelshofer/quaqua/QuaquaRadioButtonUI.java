...
public class QuaquaRadioButtonUI extends BasicRadioButtonUI implements VisuallyLayoutable {
	...
	public void paint(Graphics g, JComponent c) {
		...
		String text = layoutCL(b, fm, b.getText(), altIcon != null ? altIcon : getDefaultIcon(c), viewR, iconR, textR);
		// fill background
		if (c.isOpaque()) {
	...
	public Dimension getPreferredSize(JComponent c) {
		...
		layoutCL(b, fm, text, buttonIcon, viewR, iconR, textR);
	...
	protected void paintText(Graphics g, AbstractButton b, Rectangle textR, String text) {
		...
		QuaquaUtilities.drawStringUnderlineCharAt(g, text, mnemonicIndex, textR.x + getTextShiftOffset(),
	...
	protected String layoutCL(AbstractButton c, FontMetrics fontMetrics, String text, Icon icon, Rectangle viewR,
		...
		String clippedText = SwingUtilities.layoutCompoundLabel(c, fontMetrics, text, icon, c.getVerticalAlignment(),
	...
	public static void updateFocusableState(AbstractButton button) {
		if (UIManager.getBoolean("Button.focusable") && !UIManager.getBoolean("Button.requestFocusEnabled")) {
			...
			if (model instanceof DefaultButtonModel) {
				/*
				 * ButtonGroup grp = ((DefaultButtonModel) model).getGroup(); if (grp != null) {
				 * for (Enumeration<AbstractButton> i=grp.getElements();i.hasMoreElements();){
				 * AbstractButton btn=i.nextElement(); btn.setFocusable(btn.isSelected()); } }
				 */
