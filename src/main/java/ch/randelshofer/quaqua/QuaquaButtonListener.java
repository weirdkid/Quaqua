...
public class QuaquaButtonListener extends BasicButtonListener {
	...
	public void propertyChange(PropertyChangeEvent e) {
		...
		if (e.getSource() instanceof AbstractButton) {
			...
			if (prop == null || prop.equals("Frame.active") || prop.equals("Quaqua.Button.type")
					|| prop.equals("JButton.buttonType") || prop.equals("JButton.segmentPosition")
	...
	public void focusGained(FocusEvent e) {
		...
		if (b instanceof JButton && ((JButton) b).isDefaultCapable()) {
			...
			if (root != null) {
				QuaquaButtonUI ui = (QuaquaButtonUI) QuaquaUtilities.getUIOfType(b.getUI(), QuaquaButtonUI.class);
	...
	/**
	 * Keyboard action for selecting the next/previous button in a radio button
	 * group.
	 */
