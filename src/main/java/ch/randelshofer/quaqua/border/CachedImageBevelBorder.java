 ...
 * of a bevel and a fill area. Volatile images of the border are cached to speed
 * up drawing.
 * <p>
...
public class CachedImageBevelBorder extends CachedPainter implements Border {
	...
	protected void paintToImage(Component c, Graphics gr, int width, int height, Object args) {
		...
		if (bottom > 0 && right > 0) {
			g.drawImage(img, width - right, height - bottom, width, height, imgWidth - right, imgHeight - bottom,
					imgWidth, imgHeight, c);
		}
