 ...
 * <p>
 * Renders a native border once into an ImageBevelBorder and then uses the
 * ImageBevelBorder for further rendering.
 *
...
public class QuaquaNativeImageBevelBorder extends VisualMarginBorder implements UIResource {
	...
	public QuaquaNativeImageBevelBorder(Widget widget, Insets painterInsets, Insets imageBevelInsets,
	...
	protected ImageBevelBorder createImageBeveBorder() {
		...
		/*
		 * Graphics2D pg = painterImg.createGraphics(); pg.setColor(new Color(0x0,
		 * true)); pg.setComposite(AlphaComposite.getInstance(AlphaComposite.SRC));
	...
	public static class UIResource extends QuaquaNativeImageBevelBorder implements javax.swing.plaf.UIResource {
		...
		public UIResource(Widget widget, Insets painterInsets, Insets imageBevelInsets, Insets borderInsets,
				boolean fill) {
