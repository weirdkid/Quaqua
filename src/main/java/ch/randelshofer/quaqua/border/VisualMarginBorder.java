...
public class VisualMarginBorder extends AbstractBorder implements UIResource, VisualMargin, PressedCueBorder {
	...
	/**
	 * Defines the margin from the clip bounds of the component to its visually
	 ...
	 * Creates a new VisualMarginBorder.
	 *
	 * @param top    Defines the margin from the clip bounds of the component to its
	 *               visual bounds.
	 * @param left   Defines the margin from the clip bounds of the component to its
	 *               visual bounds.
	 * @param bottom Defines the margin from the clip bounds of the component to its
	 *               visual bounds.
	 * @param right  Defines the margin from the clip bounds of the component to its
	 *               visual bounds.
	 */
	...
	public VisualMarginBorder(int top, int left, int bottom, int right, boolean ftop, boolean fleft, boolean fbottom,
			boolean fright) {
		layoutMargin = new Insets(top, left, bottom, right);
		isTopFixed = ftop;
		isLeftFixed = fleft;
	 ...
	 * Creates a new VisualMarginBorder.
	 *
	 * @param layoutMargin Defines the margin from the clip bounds of the component
	 *                     to its visual bounds. The margin has usually negative
	 *                     values!
	 */
...
//	}
	...
	/*
	 * Specifies SwingConstants.TOP, LEFT, BOTTOM, RIGHT to be fixed. Set to false
	 * to unfix.
	 */
