...
public class CompositeVisualMarginBorder implements Border, VisualMargin {
	...
	/**
	 * Creates a new instance which draws {@code actualBorder} which has a visual
	 * margin of {@code  top,left,bottom,right}.
	 *
	 * @param actualBorder
	 * @param top
	 * @param left
	...
	public CompositeVisualMarginBorder(Border actualBorder, Insets visualMargin, boolean isTopFixed,
			boolean isLeftFixed, boolean isBottomFixed, boolean isRightFixed) {
	...
	protected Insets getVisualMargin(Component c, Insets insets) {
		/*
		 * insets.top = -visualMargin.top; insets.left = -visualMargin.left;
		 * insets.bottom = -visualMargin.bottom; insets.right = -visualMargin.right;
		 */
