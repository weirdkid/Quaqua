...
public class QuaquaPasswordFieldUI extends BasicPasswordFieldUI implements VisuallyLayoutable {
	...
	protected void installDefaults() {
		...
		/*
		 * Unfortunately we can not set the echo char from the UI. :( JPasswordField t =
		 * (JPasswordField) getComponent(); t.setEchoChar('\u2022');
		 */
	}
	...
	/**
	 * Paints a background for the view. This will only be called if isOpaque() on
	 * the associated component is true. The default is to paint the background
	 ...
	 * name <code>.keyBindings</code>. The type is expected to be
