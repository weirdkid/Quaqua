...
//            g.fillRoundRect(x + 2, y + 4, width - 4, height - 7, height -7, height - 6);
			g.fillRoundRect(x + ins.top, y + ins.left, width - ins.top - ins.bottom, height - ins.left - ins.right,
...
//            g.fillRoundRect(x + 4, y + 2, width - 7, height - 4, width - 7, width - 7);
			g.fillRoundRect(x + ins.left, y + ins.top, width - ins.left - ins.right, height - ins.top - ins.bottom,
