...
public class LionColumnView extends ColumnView {
	...
	private class FillingViewportLayout extends javax.swing.ViewportLayout {
		...
		/*
		 * Custom layout: If we are filling the preview column, then widen the view as
		 * needed to fill the viewport. This is like a conditional
		...
		/*
		 * The following method is not currently useful. QuaquaLionFileChooserUI sets a
		 * minimum size on the JSplitPane. Note that there is no way to control the
		 * minimum size of a dialog created by JFileChooser.
		 */
