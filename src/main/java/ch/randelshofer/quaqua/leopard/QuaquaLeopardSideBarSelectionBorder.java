...
public class QuaquaLeopardSideBarSelectionBorder implements Border, UIResource {
	...
	public void paintBorder(Component c, Graphics gr, int x, int y, int width, int height) {
		...
		if (QuaquaUtilities.isFocused(c)) {
			...
			g.setPaint(new LinearGradientPaint(x, y + 1, new Color(0x5c93d5), x, y + height - 1, new Color(0x1a58ad)
			...
			if (QuaquaUtilities.isOnActiveWindow(c, true)) {
				...
				g.fillRect(x, y, width, 1);
				g.setPaint(new LinearGradientPaint(x, y + 1, new Color(0xa9b1d0), x, y + height - 1, new Color(0x6e81a9)
				...
				g.fillRect(x, y, width, 1);
				g.setPaint(
						new LinearGradientPaint(x, y + 1, new Color(0xb4b4b4), x, y + height - 1, new Color(0x8a8a8a)));
			}
		}
