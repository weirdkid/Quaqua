...
public class QuaquaTreeTableUI extends BasicTreeTableUI {
	...
	protected List<String> getProperties() {
		List<String> props = new ArrayList<>(super.getProperties());
	...
	protected class MyPropertyChangeListener implements PropertyChangeListener {
		...
		/*
		 * The background of the selected row depends upon the window active state. It
		 * shouldn't - focus should be enough.
		 */
