 ...
 * References:<br>
 * <a href=
 * "http://hg.openjdk.java.net/macosx-port/macosx-port/jdk/file/tip/src/macosx/classes/com/apple/laf/"
 * >OpenJDK LaF classes</a><br>
 *
 * <a href=
 * "http://hg.openjdk.java.net/macosx-port/macosx-port/jdk/file/tip/src/macosx/classes/apple/laf/"
 * >OpenJDK JRSUIControl classes</a><br>
 * 
 * <a href=
 * "http://hg.openjdk.java.net/macosx-port/macosx-port/jdk/file/tip/src/macosx/native/com/apple/laf/"
 * > OpenJDK native code. </a>
 * </p>
 * 
...
public class OSXAquaPainter {
	...
	public enum Key {
		...
		widget(1), state(2), size(3), direction(4), orientation(5), verticalAlignment(6), horizontalAlignment(7),
		position(8), pressedPart(9), variant(10), windowType(11), focused(12), indicatorOnly(13), noIndicator(14),
		nothingToScroll(15), arrowsOnly(16), frameOnly(17), segmentTrailingSeparator(18), maximumValue(19), value(20),
		animationStartTime(21), animationTime(22), animationFrame(23), thumbProportion(24), thumbStart(25),
		windowFrameDrawClipped(26), windowFrameDrawTitleSeparator(27), windowTitleBarHeight(28);
	...
	public enum Widget {
		...
		background(1), buttonBevel(2), buttonBevelInset(3), buttonBevelRound(4), buttonCheckBox(5), buttonComboBox(6),
		buttonComboBoxInset(7), buttonDisclosure(8), buttonListHeader(9), buttonLittleArrows(10), buttonPopDown(11),
		buttonPopDownInset(12), buttonPopDownSquare(13), buttonPopUp(14), buttonPopUpInset(15), buttonPopUpSquare(16),
		buttonPush(17), buttonPushScope(18), buttonPushScope2(19), buttonPushTextured(20), buttonPushInset(21),
		buttonPushInset2(22), buttonRadio(23), buttonRound(24), buttonRoundHelp(25), buttonRoundInset(26),
		buttonRoundInset2(27), buttonSearchFieldCancel(28), buttonSearchFieldFind(29), buttonSegmented(30),
		buttonSegmentedInset(31), buttonSegmentedInset2(32), buttonSegmentedSCurve(33), buttonSegmentedTextured(34),
		buttonSegmentedToolbar(35), dial(36), disclosureTriangle(37), dividerGrabber(38), dividerSeparatorBar(39),
		dividerSplitter(40), focus(41), frameGroupBox(42), frameGroupBoxSecondary(43), frameListBox(44),
		framePlacard(45), frameTextField(46), frameTextFieldRound(47), frameWell(48), growBox(49), growBoxTextured(50),
		gradient(51), menu(52), menuItem(53), menuBar(54), menuTitle(55), progressBar(56), progressIndeterminateBar(57),
		progressRelevance(58), progressSpinner(59), scrollBar(60), scrollColumnSizer(61), slider(62), sliderThumb(63),
		synchronization(64), tab(65), titleBarCloseBox(66), titleBarCollapseBox(67), titleBarZoomBox(68),
		titleBarToolbarButton(69), toolbarItemWell(70), windowFrame(71);
	...
	public enum State {
		...
		active(1), inactive(2), disabled(3), pressed(4), pulsed(5), rollover(6), drag(7);
	...
	public enum Size {
		...
		mini(1), small(2), regular(3), large(4);
	...
	public enum Direction {
		...
		none(1), up(2), down(3), left(4), right(5), north(6), south(7), east(8), west(9);
	...
	public enum SegmentPosition {
		...
		first(1), middle(2), last(3), only(4);
	...
	public enum ScrollBarPart {
		...
		none(1), thumb(2), arrowMin(3), arrowMax(4), arrowMaxInside(5), arrowMinInside(6), trackMin(7), trackMax(8);
	...
	public enum Variant {
		...
		menuGlyph(1), menuPopup(2), menuPulldown(3), menuHierarchical(4), gradientListBackgroundEven(5),
		gradientListBackgroundOdd(6), gradientSideBar(7), gradientSideBarSelection(8),
	...
	public enum WindowType {
		...
		document(1), utility(2), titlelessUtility(3);
	...
	/**
	 * Paints the widget on the specified image. The image data must be of type
	 ...
	 * {@code BufferedImage.TYPE_INT_ARGB_PRE}.
	 * 
	 * @throws IllegalArgumentException if the image type is not
	 *                                  {@code BufferedImage.TYPE_INT_ARGB_PRE}.
	 */
	...
	/**
	 * Paints the widget on the specified image. Note: The coordinate system of the
	 * native paint method has its origin at the lower left corner. (Java has the
