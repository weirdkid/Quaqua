...
/**
 * An Icon with different visuals reflecting the state of the AbstractButton on
 * which it draws on.
 *
...
public class ButtonStateIcon extends MultiIcon {
	 ...
	 * [1] Enabled Pressed [2] Enabled Selected [3] Enabled Pressed Selected [4]
	 * Disabled [5] Disabled Selected [6] Enabled Inactive [7] Enabled Inactive
	 * Selected [8] Disabled Inactive [9] Disabled Inactive Selected
	 *
