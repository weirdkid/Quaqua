...
/**
 * An Icon with different visuals reflecting the state of the slider on which it
 * draws on.
 *
 * @author Werner Randelshofer
 * @version 4.0 2007-12-02 Added support for focus ring. <br>
 *          3.0 2005-10-17 Changed superclass to MultIcon. <br>
 *          2.0 2005-03-19 Reworked. <br>
...
public class SliderThumbIcon extends MultiIcon {
	 ...
	 * is null, an icon is derived for the state from the other icons.
	 */
	 ...
	 *
	 * The array indices are used to represente the following states: [0] Enabled
	 * [1] Enabled Pressed [2] Disabled [3] Enabled Inactive [4] Disabled Inactive
	 * [5] Focus Ring
	 *
	 * If an array element is null, an icon is derived for the state from the other
	 * icons.
	 */
	...
	public void paintIcon(java.awt.Component c, java.awt.Graphics g, int x, int y) {
		...
		if (QuaquaUtilities.isFocused(c) && icons[FOCUS_RING] != null) {
