...
/**
 * {@code ListStateIcon} draws two different icons depending on the selection
 * state of a list item. The component must set the client property
 * "Quaqua.selected" to true.
 *
