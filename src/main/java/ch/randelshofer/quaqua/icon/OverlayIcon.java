...
public class OverlayIcon implements Icon {
	...
	/**
	 * Creates a new instance. Constructor with objects only used by
	 * BasicQuaquaLookAndFeel classes. This constructor helps to reduce startuc
	 * latency, because we don't need to load the Icon interface during the first
	 * creation of BasicQuaquaLookAndFeel class.
	 */
