...
public interface VisuallyLayoutable {
	...
	/**
	 * The visually perceived bounds of a component, e.g. on a JButton with
	 * isBorderDrawn = true: the borderline except cast shadows. e.g. on a JLabel
	 * with an icon: the borderline of the icon plus the TEXT_BOUNDS of the text on
	 * the JLabel e.g. on a JLabel without an icon: the TEXT_BOUNDS of the text on
	 * the JLabel
	 *
	...
	/**
	 * The visually perceived bounds of the text on the component. If TEXT_BOUNDS is
	 * not applicable, COMPONENT_BOUNDS are used instead.
	 */
	...
	/**
	 * Returns the visual bounds for the specified component, or null if the visual
	 * bounds can not be determined.
	 *
