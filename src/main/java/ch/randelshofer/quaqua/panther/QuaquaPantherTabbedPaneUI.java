...
/**
 * The QuaquaPantherTabbedPaneUI uses to the QuaquaJaguarTabbedPaneUI for the
 * WRAP_TAB_LAYOUT policy and the QuaquaPantherScrollTabbedPaneUI for the
 * SCROLL_TAB_LAYOUT policy.
 *
...
public class QuaquaPantherTabbedPaneUI extends TabbedPaneUI implements NavigatableTabbedPaneUI {
	...
	public void installUI(JComponent c) {
		...
		if (tabPane.getTabLayoutPolicy() == JTabbedPane.WRAP_TAB_LAYOUT) {
			...
			QuaquaPantherScrollTabbedPaneUI qptpui = (QuaquaPantherScrollTabbedPaneUI) QuaquaPantherScrollTabbedPaneUI
					.createUI(c);
	...
	protected void uninstallListeners() {
		...
		/*
		 * if (focusListener != null) { tabPane.removeFocusListener(focusListener);
		 * focusListener = null; }
		 */
	}
