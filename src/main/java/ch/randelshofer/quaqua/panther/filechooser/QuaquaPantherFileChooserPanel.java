...
public class QuaquaPantherFileChooserPanel extends javax.swing.JPanel {
	...
	private static final Border cellBorder = QuaquaBorderFactory.create(
			Toolkit.getDefaultToolkit()
					.createImage(QuaquaComboBoxButton.class.getResource("images/ComboBox.cellBorder.png")),
	...
	private static final Border disabledCellBorder = QuaquaBorderFactory.create(
			Toolkit.getDefaultToolkit()
					.createImage(QuaquaComboBoxButton.class.getResource("images/ComboBox.cellBorder.D.png")),
			new Insets(10, 8, 14, 0), new Insets(1, 1, 1, 1), true);
	/**
	...
	private static final Border buttonBorder = QuaquaBorderFactory.create(
			Toolkit.getDefaultToolkit()
					.createImage(QuaquaComboBoxButton.class.getResource("images/ComboBox.buttonBorder.png")),
	...
	private static final Border pressedButtonBorder = QuaquaBorderFactory.create(
			Toolkit.getDefaultToolkit()
					.createImage(QuaquaComboBoxButton.class.getResource("images/ComboBox.buttonBorder.P.png")),
			new Insets(10, 1, 14, 8), new Insets(1, 1, 1, 1), true);
	...
	private void initComponents() {// GEN-BEGIN:initComponents
		...
		previousButton.setIcon(new javax.swing.ImageIcon(
				getClass().getResource("/ch/randelshofer/quaqua/panther/images/FileChooser.previousIcon.png")));
		navigationButtonsPanel.add(previousButton, new java.awt.GridBagConstraints());

		nextButton.setIcon(new javax.swing.ImageIcon(
				getClass().getResource("/ch/randelshofer/quaqua/panther/images/FileChooser.nextIcon.png")));
		navigationButtonsPanel.add(nextButton, new java.awt.GridBagConstraints());

		tableToggleButton.setIcon(new javax.swing.ImageIcon(
				getClass().getResource("/ch/randelshofer/quaqua/panther/images/FileChooser.tableIcon.png")));
		viewGroup.add(tableToggleButton);
		gridBagConstraints = new java.awt.GridBagConstraints();
		gridBagConstraints.insets = new java.awt.Insets(0, 5, 0, 0);
		navigationButtonsPanel.add(tableToggleButton, gridBagConstraints);

		browserToggleButton.setIcon(new javax.swing.ImageIcon(
				getClass().getResource("/ch/randelshofer/quaqua/panther/images/FileChooser.browserIcon.png")));
