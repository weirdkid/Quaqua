 ...
 * javax.swing.plaf.basic.DragRecognitionSupport 1.1 05/05/02 by Shannon Hickey.
 * This probably violates some licenses, but I don't know how to change the drag
 * and drop behavior of a TreeUI otherwise. :(
 *
...
class QuaquaDragRecognitionSupport {
	...
	/**
	 * This interface allows us to pass in a handler to mouseDragged, so that we can
	 * be notified immediately before a drag begins.
	 */
	...
	/**
	 * If a dnd recognition has been going on, return the MouseEvent that started
	 * the recognition. Otherwise, return null.
	 */
