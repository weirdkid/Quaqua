 ...
 * @version 1.1 2005-11-30 Constructor with tiled image added. <br>
 *          1.0 29 March 2005 Created.
 */
public class QuaquaToolBarButtonStateBorder extends ButtonStateBorder {
	private boolean isRollover;

	public QuaquaToolBarButtonStateBorder(Border e, Border ep, Border es, Border eps, Border d, Border ds, Border i,
			Border is, Border di, Border dis, boolean isRollover) {
	 ...
	 */
	public QuaquaToolBarButtonStateBorder(Image[] images, Insets borderInsets, Insets imageInsets, boolean fill,
			boolean isRollover) {
