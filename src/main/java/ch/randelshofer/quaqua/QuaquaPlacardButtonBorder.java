...
public class QuaquaPlacardButtonBorder extends CachedPainter implements Border {
	private final static Color[] defaultColors = { new Color(0xd8d8d8), // border top 1
			...
			/*
			 * new Color(0xcacaca), // border gradient top new Color(0xb8b8b8), // border
			 * gradient bottom
			 */
	...
	private final static Color[] selectedColors = { new Color(0xd8d8d8), // border top 1
			...
			/*
			 * new Color(0x838383), // border gradient top new Color(0x737373), // border
			 * gradient bottom
			 */
	...
	private final static Color[] disabledColors = { new Color(0xd8d8d8), // border top 1
			new Color(0x7d7d7d), // border top 2
			new Color(0x979797), // border left and right
			new Color(0x979797), // border bottom 1
			new Color(0xf5f5f5), // border bottom 2
	...
	private final static Color[] disabledSelectedColors = { new Color(0xd8d8d8), // border top 1
			new Color(0x424242), // border top 2
			new Color(0x565656), // border left and right
			new Color(0x515151), // border bottom 1
			new Color(0xb9b9b9), // border bottom 2
