...
public class QuaquaEditorKit extends DefaultEditorKit {
	...
	public Action[] getActions() {
		if (actions == null) {
			...
			actionMap.put(upAction, new QuaquaEditorKit.VerticalAction(upAction,
					(TextAction) dekActionMap.get(upAction), (TextAction) dekActionMap.get(beginAction)));
			actionMap.put(downAction, new QuaquaEditorKit.VerticalAction(downAction,
					(TextAction) dekActionMap.get(downAction), (TextAction) dekActionMap.get(endAction)));
			actionMap.put(selectionUpAction,
					new QuaquaEditorKit.VerticalAction(selectionUpAction,
			...
			actionMap.put(selectionDownAction,
					new QuaquaEditorKit.VerticalAction(selectionDownAction,
	 ...
	 * beginning of the text, if the user wants to move upwards and is already at
	 * the first line of the text. We move the cursor to the end of the text, if the
	 * user wants to move downwards and is already at the last line of the text.
	 *
	 *
	 ...
	 * DefaultCaret.getDotBias() is not accessible from outside the javax.swing.text
	 * package.
	 */
