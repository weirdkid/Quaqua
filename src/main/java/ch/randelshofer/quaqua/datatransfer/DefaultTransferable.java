...
public class DefaultTransferable implements Transferable {
	...
	/**
	 * Creates a new instance using a String as the data source. The charset
	 * parameter of the mimetype is used to convert the chars into bytes. If no
	 * charset parameter is specified <code>;charset="UTF-8"</code> is added and the
	...
	/**
	 * Creates a new instance using a char array as the data source. The charset
	 * parameter of the mimetype is used to convert the chars into bytes. If no
	 * charset parameter is specified <code>;charset="UTF-8"</code> is added and the
	 * data is encoded using UTF-8.
	 */
