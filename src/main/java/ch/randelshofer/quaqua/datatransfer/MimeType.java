...
public class MimeType implements Externalizable, Cloneable {
	...
	/**
	 * Builds a <code>MimeType</code> with the given primary and sub type but has an
	...
	/**
	 * Returns <code>true</code> if the primary type and the subtype of this object
	 * are the same as the specified <code>type</code>; otherwise returns
	 * <code>false</code>.
	 *
	 * @param type the type to compare to <code>this</code>'s type
	 * @return <code>true</code> if the primary type and the subtype of this object
	 *         are the same as the specified <code>type</code>; otherwise returns
	 *         <code>false</code>
	 */
	...
	/**
	 * Returns <code>true</code> if the primary type and the subtype of this object
	 * are the same as the content type described in <code>rawdata</code>; otherwise
	 * returns <code>false</code>.
	 *
	 * @param rawdata the raw data to be examined
	 * @return <code>true</code> if the primary type and the subtype of this object
	 *         are the same as the content type described in <code>rawdata</code>;
	 *         otherwise returns <code>false</code>; if <code>rawdata</code> is
