 ...
 * <p>
 * This class does not fix any particular bug in the Mac LAF or the Aqua LAF. It
 * is just here to achieve a consistent look with the other Quaqua menu UI
 * classes.
 *
...
public class QuaquaMenuUI extends BasicMenuUI implements QuaquaMenuPainterClient {
	 ...
	 * return getHandler(); }
	 * 
	 * protected MouseInputListener createMouseInputListener(JComponent c) { return
	 * getHandler(); }
	 */
	@Override
	...
	protected Dimension getPreferredMenuItemSize(JComponent c, Icon checkIcon, Icon arrowIcon, int defaultTextIconGap) {
		Dimension d = QuaquaMenuPainter.getInstance().getPreferredMenuItemSize(c, checkIcon, arrowIcon,
				defaultTextIconGap, acceleratorFont);
		return d;
	}
