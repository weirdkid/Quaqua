...
public class QuaquaDragGestureRecognizer implements MouseListener, MouseMotionListener {
	...
	private static int convertModifiersToDropAction(int mods, int sourceActions) {
		int modifierMask = InputEvent.ALT_DOWN_MASK | InputEvent.META_DOWN_MASK | InputEvent.SHIFT_DOWN_MASK
	 ...
	 * </ul>
	 * <p>
	 * This is implemented to check for a TransferHandler. Subclasses should perform
