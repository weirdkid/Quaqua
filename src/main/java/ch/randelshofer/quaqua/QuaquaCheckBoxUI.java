...
public class QuaquaCheckBoxUI extends BasicCheckBoxUI implements VisuallyLayoutable {
	...
	/**
	 * Preferred spacing between check boxes and other components. / private final
	 * static Insets regularSpacing = new Insets(6,6,6,6); private final static
	 * Insets smallSpacing = new Insets(6,6,6,6); private final static Insets
	 * miniSpacing = new Insets(5,5,5,5);
	 */
	...
	public void paint(Graphics g, JComponent c) {
		...
		String text = SwingUtilities.layoutCompoundLabel(c, fm, b.getText(),
				altIcon != null ? altIcon : getDefaultIcon(c), b.getVerticalAlignment(), b.getHorizontalAlignment(),
		...
		if (text != null) {
			...
			if (v != null) {
				...
				if (b.hasFocus() && b.isFocusPainted() && textR.width > 0 && textR.height > 0) {
	...
	public Dimension getPreferredSize(JComponent c) {
		...
		SwingUtilities.layoutCompoundLabel(c, fm, text, buttonIcon, b.getVerticalAlignment(),
				...
				textR, text == null ? 0 : Methods.invokeGetter(b, "getIconTextGap", 4));
	...
	protected String layoutCL(AbstractButton c, FontMetrics fontMetrics, String text, Icon icon, Rectangle viewR,
		...
		return QuaquaUtilities.layoutCompoundLabel(c, fontMetrics, text, icon, c.getVerticalAlignment(),
