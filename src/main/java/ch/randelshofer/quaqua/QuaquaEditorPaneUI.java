...
public class QuaquaEditorPaneUI extends BasicEditorPaneUI implements VisuallyLayoutable {
	...
	public Insets getVisualMargin(JTextComponent tc) {
		 ...
		 * tc.getClientProperty("Quaqua.Component.visualMargin"); if (margin == null)
		 * margin = UIManager.getInsets("Component.visualMargin"); return (margin ==
		 * null) ? new Insets(0, 0, 0 ,0) : margin;
		 */
	}
