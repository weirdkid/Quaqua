 ...
 * @version 1,3.3 2005-11-07 Method getLocale added. <br>
 *          1.3.2 2004-05-02 Method getLAFBundle without Locale as parameter
 *          added. <br>
 *          1.3.1 2002-07-30 Method getLAFBundle now takes a Locale as an
 *          additional parameter. <br>
 *          1.3 2001-10-10 The default resource name changed from 'name_Metal'
 *          to 'name'. <br>
 *          1.2 2001-07-23 Adaptation to JDK 1.3 in progress. <br>
...
public class QuaquaResourceBundleUtil {
	...
	/**
	 * Get an image icon from the ResourceBundle. <br>
	 * Convenience method .
	 *
	 * @param key The key of the property.
	 ...
	 *
	 * @param key The key of the property.
	 * @return <code>javax.swing.KeyStroke.getKeyStroke(value)</code>. Returns null
	 ...
	 */
	public static QuaquaResourceBundleUtil getBundle(String baseName) throws MissingResourceException {
		return new QuaquaResourceBundleUtil(ResourceBundle.getBundle(baseName, Locale.getDefault()));
	}

	/**
	 * Get the appropriate ResourceBundle subclass. The baseName is extended by the
	 * Swing Look and Feel ID and by the Locale code returned by
	 * Locale.getDefault().
	 *
	 ...
	 * @see java.util.ResourceBundle
	 */
	public static QuaquaResourceBundleUtil getLAFBundle(String baseName) throws MissingResourceException {
		return getLAFBundle(baseName, Locale.getDefault());
	}

	/**
	 * Get the appropriate ResourceBundle subclass. The baseName is extended by the
	 * Swing Look and Feel ID and by the Locale code.
	 *
	 * The default Look and Feel ID is Metal.
	 *
	 * @see java.util.ResourceBundle
	...
	public static QuaquaResourceBundleUtil getLAFBundle(String baseName, Locale locale)
		...
		try {
			...
			r = new QuaquaResourceBundleUtil(ResourceBundle.getBundle(baseName, locale));
		}
		return r;
	}
}
