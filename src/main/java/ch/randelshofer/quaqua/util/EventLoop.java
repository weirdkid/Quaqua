 ...
 * <p>
 * Other important features are that events are processed in the same sequence
 * as they have been collected and that only one thread is used to process the
 * events.
 * <p>
 * <b>Usage</b>
 * <p>
...
public abstract class EventLoop {
	...
	/**
	 * Indicates whether multiple events will be coalesced by the event processor or
	 * not.
	 */
	...
	/**
	 * Indicates whether events shall be enqueued add the beginning of the queue.
	 */
	 ...
	 * multiple events to be queued. Coalescing is based on equality tests of event
	 * objects. More formally, coalesces an event o if and only if the queue
	...
	/**
	 * Sets whether the EventLoop shall enqueue events at the beginning of the queue
	...
	/**
	 * This method removes events from the event queue and proceses them until the
	 * queue is empty or until #stop is called.
	 * <p>
