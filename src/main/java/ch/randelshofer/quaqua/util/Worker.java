...
/**
 * This is an abstract class that you subclass to perform GUI-related work in a
...
public abstract class Worker<T> implements Runnable {
	 ...
	 * to perform done actions on the Event Dispatch Thread.
	 *
	 ...
	 * <p>
	 * The default implementation prints a stack trace. Subclasses may override this
	 * method to perform failure actions on the Event Dispatch Thread.
	 *
	...
	/**
	 * Called on the event dispatching thread (not on the worker thread) after the
	 * <code>construct</code> method has finished and after done() or failed() has
	 * been invoked.
	 * <p>
	 * The default implementation does nothing. Subclasses may override this method
